...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: ["JSONValue.swift", "JSONLLine.swift", "JSONLDocument.swift", "JSONLColumnOrdering.swift", "JSONLColumnLayoutStore.swift", "JSONLineSearch.swift", "JSONLTimestampDisplay.swift", "UpdateChannel.swift"]
        ),
